...
interface EditNoteModalProps {
  ...
  initialPhoto: CombinedPhoto | null;
}
...
export default function EditNoteModal({
  ...
  }, [isOpen, initialNoteText, initialPhoto]);
        ...
        >
              ...
              <div>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      {selectedPhoto ? "Change Photo" : "Add Photo"} (Optional)
          ...
          <div className="px-6 py-4 border-t border-slate-200 flex items-center justify-end gap-3">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white bg-green-600 hover:bg-green-700 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isSaving ? (
                <>
