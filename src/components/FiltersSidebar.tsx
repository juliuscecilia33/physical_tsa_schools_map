      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 w-full sm:w-[450px] bg-white shadow-2xl z-[70] overflow-y-auto"
          >
            <div className="flex flex-col h-full">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={cn(
                        "flex-1 text-xs font-semibold px-3 py-2 rounded-lg border transition-all cursor-pointer",
                        filters.hasNotes === null
                          ? "bg-blue-600 text-white border-blue-600"
                          : "bg-white text-slate-700 border-slate-200 hover:border-blue-300 hover:bg-blue-50"
                      )}
              ...
              <div className="sticky bottom-0 bg-white border-t border-slate-200 px-6 py-4 flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 text-sm font-semibold rounded-xl border border-slate-200 text-slate-700 bg-white hover:bg-slate-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-white cursor-pointer"
                >
                  Clear All
                </button>
                <button
