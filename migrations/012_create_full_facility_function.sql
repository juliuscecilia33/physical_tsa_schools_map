-- Migration: Create full facility query by place_id
-- Purpose: Fetch complete facility data including heavy arrays (reviews, photos, etc.)

-- Drop function if it exists
DROP FUNCTION IF EXISTS get_facility_full_by_place_id(TEXT);

-- Create full facility query function
...
'Full facility query by place_id that includes ALL data including heavy arrays (reviews, additional_reviews, additional_photos). Use for facility detail views only.';
