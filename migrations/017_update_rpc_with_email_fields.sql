-- Migration: Update get_facility_full_by_place_id to include email fields
-- Purpose: Add email and email_scraped_at to the full facility query function

-- Drop function if it exists
DROP FUNCTION IF EXISTS get_facility_full_by_place_id(TEXT);

-- Recreate full facility query function with email fields
...
'Full facility query by place_id that includes ALL data including heavy arrays (reviews, additional_reviews, additional_photos) and email fields. Use for facility detail views only.';
