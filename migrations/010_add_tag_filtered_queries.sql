-- Migration: Add tag-filtered query functions for optimized loading
-- Purpose: Support two-phase loading (SerpAPI facilities first, then batch-load rest)
...
-- Function 1: Get facilities that have ANY of the specified tags
...
-- Function 2: Get facilities that DON'T have any of the specified tags (paginated)
...
COMMENT ON FUNCTION get_facilities_by_tags IS
'Returns facilities that have ANY of the specified tag IDs. Used for priority loading of tagged facilities (e.g., SerpAPI-scraped facilities first).';

COMMENT ON FUNCTION get_facilities_excluding_tags_paginated IS
'Returns facilities that DO NOT have any of the specified tag IDs, with pagination support. Used for background batch-loading of remaining facilities after priority load.';
